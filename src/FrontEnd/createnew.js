...
function userurl() {
  ...
  url.value = "kalam-editor.netlify.app/file/" + xy.split(" ").join("");
...
function random() {
  ...
  url.value = "https://kalam-editor.netlify.app/file/" + id;
  inputurl.value = id;
}
...
async function finalcreate() {
  ...
  if (pass.length > 0 && confpass.length > 0) {
    if (pass === confpass) {
      ...
      document.getElementById("final-btn").style.backgroundColor =
        "rgba(1,122,254,255)";
      DocID = document.getElementById("basic-url").value;
      //d---------------
      var vp = Math.random().toString(36).slice(2);
      axios.post("https://kalam-backend.onrender.com/insert", {
        DocID: DocID,
              ...
              <Col>
                ...
                <Form>
                  <Form.Label className="headings">
                    Choose Your Custom Document ID*
                  </Form.Label>
                  ...
                  <InputGroup className="mb-3" id="desiredid">
                    <InputGroup.Prepend>
                      <InputGroup.Text id="basic-addon3">file/</InputGroup.Text>
                    </InputGroup.Prepend>
                  ...
                  <InputGroup className="mb-3">
                    <FormControl
                      value="https://kalam-editor.netlify.app/file/"
                      id="myinput"
                    />
                    <InputGroup.Append>
                      <Button variant="primary" className="butt" onClick={copy}>
                        Copy
                      </Button>
                    </InputGroup.Append>
                  </InputGroup>
                  ...
                  <h6 id="pass-prompt1" class="prompt">
                    Password and Confirm Password did not match.
                  </h6>
                  <h6 id="pass-prompt2" class="prompt">
                    Password and Confirm Password matched.
                  </h6>
                  <h6 id="prompt1" class="prompt">
                    Your choosen custom ID is NOT Available.<br></br>Use "Check
                    Availability" to know if an ID is available.
                  </h6>
                  <h6 id="prompt2" class="prompt">
                    Seems like you have not entered a password.
                  </h6>
                  <Button
                    variant="primary"
                    onClick={finalcreate}
